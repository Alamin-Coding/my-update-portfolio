...
const PortfolioSection = ({ isDarkMode }: Props) => {
  ...
  const projects: Project[] = [
    {
      ...
      category: 'Web Design',
      description: 'A modern e-commerce platform with seamless shopping experience, built with Next.js and Stripe integration.',
    ...
    },
    {
      ...
      category: 'UI/UX',
      description: 'Intuitive banking dashboard with real-time analytics and transaction management features.',
    ...
    },
    {
      ...
      category: 'Mobile App',
      description: 'Mobile-first fitness app with workout tracking, nutrition planning, and social features.',
    ...
    },
    {
      ...
      category: 'Branding',
      description: 'Complete brand identity system with logo design, color palette, and brand guidelines.',
    ...
    },
    {
      ...
      category: 'Web Design',
      description: 'Comprehensive real estate portal with property listings, virtual tours, and mortgage calculator.',
    ...
    },
    {
      ...
      category: 'UI/UX',
      description: 'User-friendly travel booking platform with flight search, hotel reservations, and itinerary planning.',
  ...
  return (
    ...
    >
      ...
      <div className={`absolute top-40 right-20 w-96 h-96 rounded-full blur-3xl opacity-20 ${isDarkMode ? 'bg-cyan-500' : 'bg-cyan-400'}`}></div>
      <div className={`absolute bottom-40 left-20 w-96 h-96 rounded-full blur-3xl opacity-20 ${isDarkMode ? 'bg-purple-500' : 'bg-purple-400'}`}></div>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-2xl">
                ...
                <div className={`absolute -inset-0.5 bg-gradient-to-r ${project.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur`}></div>
        ...
        >
          ...
          >
            ...
            <div className="relative h-96 overflow-hidden rounded-t-2xl">
              ...
              />
              <div className={`absolute inset-0 bg-gradient-to-t ${selectedProject.color} opacity-20`}></div>
            </div>
